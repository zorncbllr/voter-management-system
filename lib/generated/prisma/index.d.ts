...
export namespace Prisma {
  ...
  */
  ...
  export type VoterOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"voterId" | "name" | "precinct" | "isGiven", ExtArgs["result"]["voter"]>
  ...
  export interface VoterDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `voterId`
     * const voterWithVoterIdOnly = await prisma.voter.findMany({ select: { voterId: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Voters and only return the `voterId`
     * const voterWithVoterIdOnly = await prisma.voter.createManyAndReturn({
     *   select: { voterId: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Voters and only return the `voterId`
     * const voterWithVoterIdOnly = await prisma.voter.updateManyAndReturn({
     *   select: { voterId: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface VoterFieldRefs {
    readonly voterId: FieldRef<"Voter", 'Int'>
    readonly name: FieldRef<"Voter", 'String'>
    readonly precinct: FieldRef<"Voter", 'String'>
    readonly isGiven: FieldRef<"Voter", 'Boolean'>
  }
  ...
  export type VoterWhereInput = {
    ...
    voterId?: IntFilter<"Voter"> | number
  ...
  export type VoterScalarWhereWithAggregatesInput = {
    ...
    voterId?: IntWithAggregatesFilter<"Voter"> | number
    name?: StringWithAggregatesFilter<"Voter"> | string
    precinct?: StringWithAggregatesFilter<"Voter"> | string
    isGiven?: BoolWithAggregatesFilter<"Voter"> | boolean
  }
  ...
  export type VoterUpdateInput = {
    ...
    precinct?: StringFieldUpdateOperationsInput | string
    isGiven?: BoolFieldUpdateOperationsInput | boolean
  }
